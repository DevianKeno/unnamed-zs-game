    ...
    SubShader {
        ...
        Pass {
            ...
            pixel_t VertShader(vertex_t input)
            {
                ...
                //Niter: This is the actual trick
                ...
                //Niter: This disables the rendering when you are looking the  text from it's side. You have to remove it to use billboard or it will get transparent when you are not facing or backfacing it
