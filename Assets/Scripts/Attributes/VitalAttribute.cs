...
//             changeType = ChangeTypeFromString(data.ChangeType);
//             timeCycle = TimeCycleFromString(data.TimeCycle);
...
//         public override AttributeSaveData WriteSaveJson()
//         {
//             var saveData = base.WriteSaveJson();

//             saveData.AllowChange = allowChange;
//             saveData.ChangeType = changeType.ToString().ToLower();
//             saveData.TimeCycle = timeCycle.ToString().ToLower();
//             saveData.BaseChange = baseChange;
//             saveData.ChangeMultiplier = changeMultiplier;
//             saveData.ChangeFlatBonus = changeFlatBonus;
//             saveData.EnableDelayedChange = enableDelayedChange;
//             saveData.DelayedChangeDuration = delayedChangeDuration;

//             return saveData;
//         }

//         VitalAttributeChangeType ChangeTypeFromString(string value)
//         {
//             return value switch
//             {
//                 "static" => VitalAttributeChangeType.Static,
//                 "regen" => VitalAttributeChangeType.Regen,
//                 "degen" => VitalAttributeChangeType.Degen,
//                 _ => VitalAttributeChangeType.Static,
//             };
//         }

//         VitalAttributeTimeCycle TimeCycleFromString(string value)
//         {
//             return value switch
//             {
//                 "second" => VitalAttributeTimeCycle.Second,
//                 "tick" => VitalAttributeTimeCycle.Tick,
//                 _ => VitalAttributeTimeCycle.Second,
//             };
//         }
//     }
// }