...
//         {
//             xThreads = Game.World.World.Attributes.ChunkSize / 8 + 1;
//             yThreads = Game.World.World.Attributes.WorldHeight / 8;
        
//             noiseLayersArray = new ComputeBuffer(noiseLayers.Length, 36);
//             noiseLayersArray.SetData(noiseLayers);

//             noiseShader.SetInt("containerSizeX", Game.World.World.Attributes.ChunkSize);
//             noiseShader.SetInt("containerSizeY", Game.World.World.Attributes.WorldHeight);

//             noiseShader.SetBool("generateCaves", true);
//             noiseShader.SetBool("forceFloor", true);

//             noiseShader.SetInt("maxHeight", Game.World.World.Attributes.WorldHeight);
...
//             VoxelColor32[] converted = new VoxelColor32[Game.World.World.WorldColors.Length];
//             int cCount = 0;

//             foreach (VoxelColor c in Game.World.World.WorldColors)
//             {
...
//             voxelShader.SetInt("containerSizeX", Game.World.World.Attributes.ChunkSize);
//             voxelShader.SetInt("containerSizeY", Game.World.World.Attributes.WorldHeight);
...
//             {
//                 if (Game.World.World.activeContainers.ContainsKey(pos))
//                 {
//                     Game.World.World.activeContainers[pos].UploadMesh(meshBuffer);
//                 }
...
//             noiseBuffer = new ComputeBuffer(Game.World.World.Attributes.ChunkCount, 4);
//             Initialized = true;
//         }
