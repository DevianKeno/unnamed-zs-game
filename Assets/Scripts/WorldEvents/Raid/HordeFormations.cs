...
//     {
//         Player player;
//         GameObject hordeParent;
//         public void HandlePrerequisites(RaidInstance raidInstance, Player selectedPlayer)
//         {
//             player = selectedPlayer;
//             hordeParent = new GameObject("HordeHolder");
//             Instantiate(hordeParent);
...
//             {
//                 Game.Entity.Spawn<Skinwalker>(raidInstance.enemyId, callback: (info) => {
//                     info.Entity.transform.SetParent(hordeParent.transform);
//                     info.Entity.transform.position = player.transform.position + new Vector3(UnityEngine.Random.Range(-5, 5), 0, UnityEngine.Random.Range(-5, 5));
//                 });
//             }
//         }
